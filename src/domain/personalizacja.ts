...
const PALETA_MIDNIGHT: PaletaPersonalizacji = {
  ...
  sidebar: '#121f17',
  sidebarHover: '#1d3021',
  sidebarActive: '#304a2a',
  focus: '#7fa866',
  timeline: '#3d5872',
  timelineTeraz: '#7fa866',
}
...
const PALETA_OLED: PaletaPersonalizacji = {
  ...
  sidebar: '#020605',
  sidebarHover: '#0e1b18',
  sidebarActive: '#2b4326',
  akcent: '#88b46b',
  akcentHover: '#9cc183',
  focus: '#88b46b',
  timeline: '#3c4844',
  timelineTeraz: '#88b46b',
}
...
const PALETA_SOFT: PaletaPersonalizacji = {
  ...
  sidebar: '#263a22',
  sidebarHover: '#31492b',
  sidebarActive: '#416237',
  focus: '#587a3d',
  timeline: '#bcb5aa',
  timelineTeraz: '#587a3d',
}
...
const CIENIE = {
  brak: 'none',
  lekki: '0 1px 2px rgb(25 45 22 / 8%), 0 10px 30px rgb(25 45 22 / 7%)',
