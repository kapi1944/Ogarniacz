...
export function WidokPulpitu() {
  ...
  return <div className="widok widok-pulpitu">
    ...
    <section className="pulpit-sekcja--uwaga centrum-dowodzenia">
      ...
      <Karta klasa="centrum-dowodzenia__bok"><div className="tytul-karty"><Inbox aria-hidden="true" /><span>Poczekalnia</span></div>{elementyPoczekalni.length === 0 ? <p className="tekst-pomocniczy">Poczekalnia jest pusta.</p> : <><strong className="pulpit-licznik-uwagi">{elementyPoczekalni.length}</strong><p className="tekst-pomocniczy">{elementyPoczekalni.length === 1 ? 'sprawa czeka na uporządkowanie' : 'spraw czeka na uporządkowanie'}</p><Link className="przycisk przycisk--tekstowy" to="/poczekalnia">Otwórz poczekalnię</Link></>}</Karta>
    </section>
