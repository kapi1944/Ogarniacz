...
import { przygotujBackupDoPrzywracania, przywrocBackup, SEKCJE_BACKUPU, utworzBackup, wyczyscDane, type NazwaSekcjiBackupu, type OgarniaczBackup } from '../../services/BackupService'
...
export function WidokUstawien() {
  ...
  return <div className="widok widok-ustawien">
    ...
    <Karta><h2>Informacje o aplikacji</h2><p><strong>Ogarniacz v1.0.0</strong> · local-first PWA · schemat IndexedDB v4 · bez backendu i zewnętrznego API.</p><p className="tekst-pomocniczy">Systemowe alarmy po całkowitym zamknięciu aplikacji, zdalne współdzielenie i synchronizacja wymagają przyszłej warstwy platformowej/backendowej.</p></Karta>
