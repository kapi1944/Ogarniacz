  ...
  return <section className="panel-ustawien-aplikacji" aria-labelledby="ustawienia-aplikacji-tytul">
    ...
    <div className="siatka-sekcji-ustawien">
      ...
      <SekcjaUstawien tytul="Harmonogram" resetuj={() => resetujSekcje('harmonogram')}>
        ...
        <label className="pole"><span>Dojazd do pracy (min)</span><input type="number" min="0" max="180" value={szkic.harmonogram.dojazdDoPracyMinuty} onChange={(e) => aktualizujSzkic({ ...szkic, harmonogram: { ...szkic.harmonogram, dojazdDoPracyMinuty: Number(e.target.value) } })} /></label>
